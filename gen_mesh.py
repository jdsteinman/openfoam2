...
vert = np.array([
    ...
    [R, 0, -0.5], # 8
    [R*sqrt(2)/2, R*sqrt(2)/2, -0.5], # 9
    [0, R, -0.5], # 10
    [-R*sqrt(2)/2, R*sqrt(2)/2, -0.5], # 11
    [-R, 0, -0.5], # 12
    [-R*sqrt(2)/2, -R*sqrt(2)/2, -0.5], # 13
    [0, -R, -0.5], # 14
    [R*sqrt(2)/2, -R*sqrt(2)/2, -0.5], # 15

    [Lw, 0, -0.5], # 16
    [Lw, R*sqrt(2)/2, -0.5], # 17
    [Lw, H, -0.5], # 18
    [R*sqrt(2)/2, H, -0.5], # 19
    [0, H, -0.5], # 20
    [-R*sqrt(2)/2, H, -0.5], # 21
    [-Lf, H, -0.5], # 22
    [-Lf, R*sqrt(2)/2, -0.5], # 23
    
    [-Lf, 0, -0.5], # 24
    [-Lf, -R*sqrt(2)/2, -0.5], # 25
    [-Lf, -H, -0.5], # 26
    [-R*sqrt(2)/2, -H, -0.5], # 27
    [0, -H, -0.5], # 28
    [R*sqrt(2)/2, -H, -0.5], # 29
    [Lw, -H, -0.5], # 30
    [Lw, -R*sqrt(2)/2, -0.5] # 31
])
