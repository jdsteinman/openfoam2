...
vert = np.array([
    [0.5, 0, -0.5], # 0
    [0.5*sqrt(2)/2, 0.5*sqrt(2)/2, -0.5], # 1
    [0, 0.5, -0.5], # 2
    [-0.5*sqrt(2)/2, 0.5*sqrt(2)/2, -0.5], # 3
    [-0.5, 0, -0.5], # 4
    [-0.5*sqrt(2)/2, -0.5*sqrt(2)/2, -0.5], # 5
    [0, -0.5, -0.5], # 6
    [0.5*sqrt(2)/2, -0.5*sqrt(2)/2, -0.5], # 7

    [RR, 0, -0.5], # 8
    [RR*sqrt(2)/2, RR*sqrt(2)/2, -0.5], # 9
    [0, RR, -0.5], # 10
    [-RR*sqrt(2)/2, RR*sqrt(2)/2, -0.5], # 11
    [-RR, 0, -0.5], # 12
    [-RR*sqrt(2)/2, -RR*sqrt(2)/2, -0.5], # 13
    [0, -RR, -0.5], # 14
    [RR*sqrt(2)/2, -RR*sqrt(2)/2, -0.5], # 15

    [Lw, 0, -0.5], # 16
    [Lw, RR*sqrt(2)/2, -0.5], # 17
    [Lw, H, -0.5], # 18
    [RR*sqrt(2)/2, H, -0.5], # 19
    [0, H, -0.5], # 20
    [-RR*sqrt(2)/2, H, -0.5], # 21
    [-Lf, H, -0.5], # 22
    [-Lf, RR*sqrt(2)/2, -0.5], # 23
    
    [-Lf, 0, -0.5], # 24
    [-Lf, -RR*sqrt(2)/2, -0.5], # 25
    [-Lf, -H, -0.5], # 26
    [-RR*sqrt(2)/2, -H, -0.5], # 27
    [0, -H, -0.5], # 28
    [RR*sqrt(2)/2, -H, -0.5], # 29
    [Lw, -H, -0.5], # 30
    [Lw, -RR*sqrt(2)/2, -0.5] # 31
])
